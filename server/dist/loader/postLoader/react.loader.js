...
exports.createReactsByPostLoader = void 0;
const dataloader_1 = __importDefault(require("dataloader"));
const react_entity_1 = require("../../entities/react.entity");
const getRepo_1 = require("../../utils/getRepo");
const typeorm_1 = require("typeorm");
const createReactsByPostLoader = () => new dataloader_1.default(async (postIds) => {
...
exports.createReactsByPostLoader = createReactsByPostLoader;
